...
public class LvyRecycleAdapters extends XRecyclerView.Adapter<XRecyclerView.ViewHolder> {
    ...
    public LvyRecycleAdapters(List<CarBean.ItemBean> list, Context context) {
        this.list = list;
