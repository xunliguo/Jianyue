...
public class EntertainmentFrament extends Fragment {
    private XRecyclerView recyclerView;
    private ArrayList<CarBean.ItemBean> mlist = new ArrayList<>();
    private Banner banner;
    int page = 1;
    //娱乐
    private String url="http://api.iclient.ifeng.com/ClientNews?id=YL53,FOCUSYL53&";
    private CarRecycleAdapters adapters;
    ...
    private void initData() {
        adapters = new CarRecycleAdapters(mlist, getActivity());
        ...
        adapters.setOnclick(new CarRecycleAdapters.Listener() {
            @Override
        ...
        adapters.setOnclicktwo(new CarRecycleAdapters.Listeneritemtwo() {
            @Override
        ...
        adapters.setOnclickThree(new CarRecycleAdapters.Listeneritemthree() {
            @Override
