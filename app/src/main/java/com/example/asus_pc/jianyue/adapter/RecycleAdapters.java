...
import static com.example.asus_pc.jianyue.R.id.bannerContainer;
import static com.example.asus_pc.jianyue.R.id.item1_timer;
import static com.example.asus_pc.jianyue.R.id.largeLabel;
import static com.example.asus_pc.jianyue.R.id.packed;
...
public class RecycleAdapters extends XRecyclerView.Adapter<XRecyclerView.ViewHolder> {
    private List<HeadLinBean.ItemBean> list;
    private Context context;
    private Listener listener;
    private Listeneritemtwo listeneritemtwo;
    private Listeneritemthree listeneritemthree;
    public RecycleAdapters(List<HeadLinBean.ItemBean> list, Context context) {
        this.list = list;
