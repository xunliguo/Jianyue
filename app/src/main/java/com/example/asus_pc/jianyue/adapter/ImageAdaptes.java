...
import static com.example.asus_pc.jianyue.R.layout.item;
import static com.example.asus_pc.jianyue.R.layout.listview_footer;

/**
 * Created by ASUS-PC on 2017/8/22.
 */

public class ImageAdaptes extends XRecyclerView.Adapter<ImageAdaptes.ViewHolder> {
private List<ImageBean.ImgsBean> list;
    private Context context;
  private Listener listener;
    private List<Integer> heights;

    public ImageAdaptes(List<ImageBean.ImgsBean> list, Context context) {
        this.list = list;
    ...
    @Override
    public ImageAdaptes.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = View.inflate(context, R.layout.image_item, null);
        ViewHolder vholer=new ViewHolder(inflate);
        return vholer;
    }

    @Override
    public void onBindViewHolder(ImageAdaptes.ViewHolder holder, final int position) {
